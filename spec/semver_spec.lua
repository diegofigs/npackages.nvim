...
describe("npackages.semver", function()
	...
	it("can match wildcard", function()
		assert_match("2.0.5", "2.0.*")
		assert_match("2.0.5", "2.*")
		assert_match("2.0.5", "*")
	...
	it("can match less than", function()
	...
	it("can match less than or equal", function()
	...
	it("can match greater than", function()
	...
	it("can match greater than or equal", function()
