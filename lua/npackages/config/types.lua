...
-- To update it:
-- 1. Edit the schema in `lua/npackages/config/internal.lua`
...
---@field cmp CmpConfig
---@field coq CoqConfig
---@field npackages PackageCompletionConfig
...
---@field public text? npackages.UserTextConfig
---@field public highlight? npackages.UserHighlightConfig
---@field public popup? npackages.UserPopupConfig
---@field public completion? npackages.UserCompletionConfig
---@field public null_ls? npackages.UserNullLsConfig
---@field public lsp? npackages.UserLspConfig
...
---@class npackages.UserPopupConfig
...
---@field public text? npackages.UserPopupTextConfig
---@field public highlight? npackages.UserPopupHighlightConfig
---@field public keys? npackages.UserPopupKeyConfig

---@class npackages.UserPopupTextConfig
...
---@class npackages.UserPopupHighlightConfig
---@field public title? string
...
---@class npackages.UserPopupKeyConfig
...
---@class npackages.UserCompletionConfig
---@field public insert_closing_quote? boolean
---@field public text? npackages.UserCompletionTextConfig
---@field public cmp? npackages.UserCmpConfig
---@field public coq? npackages.UserCoqConfig
---@field public npackages? npackages.UserPackageCompletionConfig

---@class npackages.UserCompletionTextConfig
---@field public prerelease? string
---@field public yanked? string

---@class npackages.UserCmpConfig
---@field public enabled? boolean
---@field public use_custom_kind? boolean
---@field public kind_text? npackages.UserCmpKindTextConfig
---@field public kind_highlight? npackages.UserCmpKindHighlightConfig

---@class npackages.UserCmpKindTextConfig
---@field public version? string
---@field public feature? string
...
---@class npackages.UserPackageCompletionConfig
---@field public enabled? boolean
---@field public min_chars? integer
---@field public max_results? integer

---@class npackages.UserNullLsConfig
---@field public enabled? boolean
---@field public name? string

---@class npackages.UserLspConfig
---@field public enabled? boolean
---@field public name? string
